      ...
      style={styles.top}>
        ...
        <View style={styles.circle}>
          ...
          <Text style={styles.dsgtext}>{nameDetails.designation}</Text>
           ...
           <ImageBackground 
           style={{height:hp(80)}}
           source={{uri:'https://image.shutterstock.com/image-vector/abstract-white-background-minimal-geometric-260nw-2281284523.jpg'}}
           >
      ...
      <View style={{ marginLeft:wp(5)}}> 
         ...
         <View style={styles.rowicon}>
          ...
          <View style={styles.circle2}>
            ...
            <Text style={styles.text}>Emp-Id:111</Text>
          </View>
          <View style={styles.rowicon}>
          <View style={styles.circle2}>
            <MaterialIcons name="bloodtype" size={24} color="white" />
            </View>
            <Text style={styles.text}>Blood Group: O+ve</Text>
          </View>
          ...
          <View style={styles.rowicon}>
          <View style={styles.circle2}>
            <FontAwesome5 name="calendar-alt" size={19} color="white" />
            </View>
            <Text style={styles.text}>Jionind In:Nov 6th,2023</Text>
          </View>
          <View style={styles.rowicon}>
          <View style={styles.circle2}>
        ...
        <MaterialCommunityIcons name="instagram" size={37} color="#1E5B70" />
